...
typedef enum {
    ...
    NAMidiParserErrorKindIllegalTimeSignBeforeMeasuredStep,
    NAMidiParserErrorKindIllegalTimeSignBeforeLastTimeSign,
    NAMidiParserErrorKindIllegalTimeSignLocation,
